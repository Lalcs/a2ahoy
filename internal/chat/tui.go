...
func RunTUI(ctx context.Context, c client.A2AClient, card *a2a.AgentCard, baseURL string, initialParts []*a2a.Part, cfg *a2a.SendMessageConfig) error {
	...
	_ = baseURL
	m := newModel(ctx, c, card, initialParts, cfg)
